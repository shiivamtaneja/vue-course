...
const handleFormSubmit = async () => {
  ...
  try {
    ...
    console.error("Erorr adding new job ", err);
    ...
    <div class="container max-w-2xl py-24 m-auto">
      ...
      >
        <form @submit.prevent="handleFormSubmit">
          ...
          <div>
            <button
              class="w-full px-4 py-2 font-bold text-white bg-green-500 rounded-full cursor-pointer hover:bg-green-600 focus:outline-none focus:shadow-outline"
              type="submit"
            >
              Add Job
            </button>
